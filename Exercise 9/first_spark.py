...
def main(in_directory, out_directory):
    ...
    col = with_bins['y'] # Inspired from https://spark.apache.org/docs/3.1.2/api/python/reference/api/pyspark.sql.functions.avg.html .
    groups = grouped.agg(
        functions.sum(with_bins['x']),
        functions.avg(col), # TODO: output the average y value. Hint: avg. Adapted from https://spark.apache.org/docs/3.1.2/api/python/reference/api/pyspark.sql.functions.avg.html .
        functions.count('*'))
